...
| Model adapters | Hugging Face/local models, FunctionGemma, OpenAI, Groq, NVIDIA, arbitrary endpoints, OpenAI-compatible servers | Local contracts pass; the checked-in remote regression suite currently fails | [Model adapters](./functionalities/models.md) |
